...
for p in listOfPersons:
    ...
    for k in range(0,4):
        ...
        for key in p.keys():
            if(key == "federal_ein"):
                latexF.write("\n\PlaceText{"+str(95)+"mm}{"+str(53+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "employer_name"):
                latexF.write("\n\PlaceText{"+str(15)+"mm}{"+str(30+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "employer_address"):
                emploAddress = p[key]
            elif(key == "ssn"):
                latexF.write("\n\PlaceText{"+str(130)+"mm}{"+str(53+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "emp_name"):
                name = p[key]
            elif(key == "last_name"):
                lastName = p[key]
                ...
                latexF.write("\n\PlaceText{"+str(130)+"mm}{"+str(15+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "fit_withheld"):
                latexF.write("\n\PlaceText{"+str(166)+"mm}{"+str(15+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "ss_wages"):
                latexF.write("\n\PlaceText{"+str(130)+"mm}{"+str(22+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "ss_withheld"):
                latexF.write("\n\PlaceText{"+str(166)+"mm}{"+str(22+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "med_wages"):
                latexF.write("\n\PlaceText{"+str(130)+"mm}{"+str(28+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "med_withheld"):
                latexF.write("\n\PlaceText{"+str(166)+"mm}{"+str(28+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "ss_tips"):
                latexF.write("\n\PlaceText{"+str(95)+"mm}{"+str(22+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "allocated_tips"):
                latexF.write("\n\PlaceText{"+str(95)+"mm}{"+str(28+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "eic_payment"):
                print(p[key])
            elif(key == "dependent_care"):
                latexF.write("\n\PlaceText{"+str(130)+"mm}{"+str(34+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "non_qual_plan"):
                latexF.write("\n\PlaceText{"+str(166)+"mm}{"+str(34+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "stat_employee"):
                latexF.write("\n\PlaceText{"+str(131)+"mm}{"+str(46+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "retirement_plan"):
                latexF.write("\n\PlaceText{"+str(143)+"mm}{"+str(46+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "sick_pay"):
                latexF.write("\n\PlaceText{"+str(154)+"mm}{"+str(46+Y+(k*1.5))+"mm}{"+p[key]+"}")
                ...
                latexF.write("\n\PlaceText{"+str(95)+"mm}{"+str(40+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_meaninga"):
                latexF.write("\n\PlaceText{"+str(105)+"mm}{"+str(40+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_codeb"):
                latexF.write("\n\PlaceText{"+str(130)+"mm}{"+str(40+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_meaningb"):
                latexF.write("\n\PlaceText{"+str(140)+"mm}{"+str(40+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_codec"):
                latexF.write("\n\PlaceText{"+str(166)+"mm}{"+str(40+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_meaningc"):
                latexF.write("\n\PlaceText{"+str(176)+"mm}{"+str(40+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_coded"):
                latexF.write("\n\PlaceText{"+str(95)+"mm}{"+str(46+Y+(k*1.5))+"mm}{"+p[key]+"}")
            elif(key == "box12_meaningd"):
                latexF.write("\n\PlaceText{"+str(105)+"mm}{"+str(46+Y+(k*1.5))+"mm}{"+p[key]+"}")
        ...
        latexF.write("\n\PlaceText{"+str(15)+"mm}{"+str(48+Y+(k*1.5))+"mm}{"+name+" "+suff+" "+lastName+"}")
        ...
        for a in address.split('\n'):
            if(i==0):
                ...
                a2 = a
            i += 1
        latexF.write("\n\PlaceText{"+str(15)+"mm}{"+str(53+Y+(k*1.5))+"mm}{"+a1+"}")
        latexF.write("\n\PlaceText{"+str(15)+"mm}{"+str(56+Y+(k*1.5))+"mm}{"+a2+"}")
        ...
        for a in emploAddress.split('\n'):
            if(i==0):
                ...
                ae2 = a
            i += 1
        latexF.write("\n\PlaceText{"+str(15)+"mm}{"+str(34+Y+(k*1.5))+"mm}{"+ae1+"}")
        latexF.write("\n\PlaceText{"+str(15)+"mm}{"+str(38+Y+(k*1.5))+"mm}{"+ae2+"}")
